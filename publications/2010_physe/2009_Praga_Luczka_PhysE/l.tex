\documentclass[a4,twocolumn,showpacs,showkeys]{revtex4}
\usepackage{graphicx}
\usepackage{amsmath}
\usepackage{amssymb}
...
\author{L. Machura}
\affiliation{Institute of Physics, University of Silesia,
...
\author{P. Talkner}
\affiliation{Institute of Physics, University of Augsburg,
...
\keywords {Josephson junction, anomalous transport, negative conductance, diffusion, voltage fluctuations,   efficiency}  

\pacs{
74.25.Fy % transport properties of superconductance (conductance)
